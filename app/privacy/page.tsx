...
export const metadata = {
  title: 'Privacy Policy — LeverageOS',
  description: 'How LeverageOS handles your data. Short version: we don\'t sell it, we minimize it, and you own it.',
}
      ...
      <article className="max-w-2xl mx-auto px-6 pb-32 prose prose-invert prose-sm max-w-none">
        <div className="space-y-10 mt-12">
          ...
          {[
            {
              title: '1. Who we are',
              body: 'LeverageOS, Inc. ("LeverageOS", "we", "us") is a company that sells AI-configured laptop computers. Our registered address is available on request. For privacy questions, contact us at privacy@leverageos.com.',
            },
            {
...
All service providers are under contractual obligation to handle your data securely and only for the purposes we specify.`,
            },
            {
              ...
              body: 'Your LeverageOS device runs AI tools (Claude, Perplexity, etc.) under your own accounts. Your interactions with those tools are governed by their respective privacy policies. LeverageOS does not have access to your AI conversations or outputs.',
            },
            {
