...
const STEPS = [
  ...
  },
  {
    ...
    detail: [
      ...
      'Kaal configuration layer installed',
  ...
  },
  {
    ...
    subtitle: 'Day 1',
    description: '94% of Kaal customers achieve a meaningful result within their first 8 hours. A task that used to take an afternoon now takes 15 minutes. You feel it the first day.',
    detail: [
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="kaal-panel text-white">
        <div className="bg-grid-pattern/0 pt-36 pb-24 text-center max-w-4xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-1 rounded-2xl overflow-hidden border border-border/40">
          ...
          <div className="bg-emerge-500/5 p-1">
            <div className="bg-emerge-500/10 rounded-xl p-3 mb-1">
              <p className="text-xs font-semibold text-emerge-400 uppercase tracking-wider text-center">After Kaal</p>
            </div>
            <div className="space-y-1 p-2">
              {COMPARISON.map(c => (
                <div key={c.aspect} className="p-3 rounded-lg">
