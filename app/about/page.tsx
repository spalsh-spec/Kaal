...
const VALUES = [
  ...
  },
  {
    ...
    body: 'The hardware depreciates. The stack appreciates. Monthly updates are not a feature — they\'re the entire model. Your Kaal device should be more valuable in 12 months than the day it shipped.',
  },
  {
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-3xl mx-auto px-6 pb-24" id="manifesto">
        ...
        >
          <div className="text-lg text-foreground/80 leading-relaxed space-y-6">
            <p>
              We started Kaal because we were watching something unfair happen.
            </p>
            <p>
            ...
            <p className="text-volta-300 font-medium text-xl">
              We built Kaal to close that gap permanently.
            </p>
            <p>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-24">
        <div className="rounded-2xl border border-border/40 bg-card/30 p-10">
          <h2 className="text-2xl font-semibold text-center mb-8">Kaal by the numbers</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { value: '2,400+', label: 'Professionals using Kaal' },
      ...
      <section className="max-w-5xl mx-auto px-6 pb-24" id="press">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {[
            { outlet: 'TechCrunch', quote: '"Kaal makes a genuine case for being the first truly non-developer AI computer."', date: 'January 2025' },
            ...
            { outlet: 'Fast Company', quote: '"What Apple did for smartphones, Kaal is trying to do for AI. It\'s ambitious. It might work."', date: 'March 2025' },
          ].map(p => (
