...
const PROFESSION_DETAILS: Record<string, {
  ...
  marketing: {
    ...
    promise: 'LeverageOS comes pre-loaded with every AI tool a marketing professional needs, configured to work together. From brief to published in the time it used to take to write a brief.',
    workflows: [
    ...
    quote: 'My team thinks I hired a full agency. I just have LeverageOS.',
  ...
  lawyer: {
    ...
    pain: 'Billable hours are being squeezed. Clients expect faster turnaround and lower bills. You\'re competing with legal tech startups that hired AI engineers. You don\'t need to hire engineers — you need LeverageOS.',
  ...
  doctor: {
    ...
    promise: 'LeverageOS for Medical Professionals is built specifically for clinicians. SOAP notes before you leave the room. Drug interaction checks in seconds. Literature reviews in minutes. Fully HIPAA-compatible workflows.',
    workflows: [
  ...
  student: {
    ...
    promise: 'LeverageOS for Students gives you research superpowers, writing acceleration, and study tools that adapt to how you actually learn. Straight As aren\'t about working harder — they\'re about working with the right tools.',
    workflows: [
  ...
  creator: {
    ...
    promise: 'LeverageOS for Creators combines scripting AI, thumbnail generation, YouTube SEO, voiceover tools, and video editing AI into one configured system. 4× the output. The same you.',
    workflows: [
  ...
  executive: {
    ...
    promise: 'LeverageOS for Executives is configured for the way leaders actually work: email triage, meeting prep and summaries, board decks, market intelligence, and strategic research — all on one device, ready to go.',
    workflows: [
  ...
  finance: {
    ...
    promise: 'LeverageOS for Finance pre-installs Excel AI, report generation agents, earnings summary tools, and market research automation. Monthly reports in an hour. Risk analysis without the grind.',
    workflows: [
    ...
    quote: 'My junior analysts thought I had a team working overnight. It was just LeverageOS.',
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="glass rounded-2xl p-6 border-emerge-500/20">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">LeverageOS Fix</p>
                </div>
